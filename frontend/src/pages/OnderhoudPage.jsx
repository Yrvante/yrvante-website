...
const OnderhoudPage = () => {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section className="pt-32 pb-16 lg:pt-40 lg:pb-24 bg-gradient-to-b from-gray-900 to-gray-800 text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex items-baseline gap-2 mb-6">
                ...
                <span className="text-xs text-gray-500 ml-2">{language === 'nl' ? 'excl. BTW' : 'excl. VAT'}</span>
              </div>
